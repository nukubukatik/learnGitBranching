...
describe('GitEngine', function() {
  ...
  // it('Rebases', function() {
  //   expectTree(
  //     'hc; hg update -b side C1; gc; git rebase master',
  ...
  it('Merges', function() {
    expectTree(
      'hc; hg checkout C1; hg bm side;  hc; hg merge master',
